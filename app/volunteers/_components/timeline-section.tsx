...
interface TimelinesSectionProps {
  ...
  onUpdateTimeline: (
    index: number,
    field: "organization" | "startYear" | "endYear",
    value: any,
  ) => void;
  ...
  return (
    <div className="space-y-3">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="space-y-1">
                ...
                <div className="bg-gray-600 border border-gray-500 rounded-md px-3 py-1 text-gray-100 text-sm flex items-center">
      ...
      <p className="text-xs text-gray-400">
        Record volunteer service history and experience.
      </p>
    </div>
  );
}
