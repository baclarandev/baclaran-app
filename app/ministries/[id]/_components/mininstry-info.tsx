...
import { useMinistryByID } from "@/app/services/ministries";
...
export default function MinistryInfo({
  user,
  ministryId,
}: {
  user: any;
  ...
  // fetch volunteers array directly
  const { data: volunteers = [], isLoading } = useMinistryByID(ministryId);
