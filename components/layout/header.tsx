...
export function Header({ user, onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 bg-neutral-900 items-center gap-4 px-6  backdrop-blur-md border-b border-white/20 shadow-md  ">
      {/* Mobile menu button */}
      <button
      ...
      {/* Page title */}
      <div className="flex items-center font-mono gap-2 text-lg  text-white dark:text-red-400">
        {pageTitle}
      </div>
